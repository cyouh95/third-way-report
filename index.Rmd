...
Empirical research shows that public research universities responded to declining state appropriations by dramatically increasing nonresident enrollment.<sup>`r cite_RN3753`</sup> Specifically, a 10% decline in state appropriations was associated with a 4.6% increase in nonresident freshman enrollment. Since these nonresident students tended to be more affluent and were less likely to be black or Latinx than resident students, growth in the share of nonresident students was associated with declines in the share of Pell Grant recipients and black/Latinx students at public research universities.<sup>`r cite_RN3685`</sup> At prestigious public research universities like the University of Michigan and the University of California-Berkeley, nonresident enrollment growth had a negative causal effect resident enrollment.<sup>`r cite_RN4290`</sup> While prestigious public research universities enjoy strong demand from high-achieving out-of-state students, the majority of public research universities, like the University of Arizona and the University of Arkansas, compete for out-of-state students who cannot gain admission to their own state flagship. As a result, less prestigious public flagship universities have adopted institutional "merit aid" programs specifically designed to target out-of-state students with mediocre academic achievement.

<!--
<sup>`r paste(cite_RN4409, cite_RN4032, cite_RN3762, sep = ", ")`</sup>
<sup>`r paste(cite_RN4409, cite_RN4032, cite_RN3762, cite_RN4494, sep = ", ")`</sup>
-->
