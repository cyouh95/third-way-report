...
apndx_nums <- captioner::captioner(prefix = 'Appendix Table A', auto_space = FALSE)
...
`r tbl_nums('event_count', display='cite')` shows the number of recruiting visits by type of institution visited (e.g., public high school, private high school, other) and whether the visit was in-state or out-of-state. Across all of 15 public research universities in our sample, the majority of visits were to public high schools. However, our most dramatic finding is that most universities made more out-of-state than in-state visits---a principle that runs counter to the stated missions of large, state-based university systems. Seven universities made _more than twice_ as many out-of-state than in-state visits. And, when compared to in-state visits, a disproportionate number of these out-of-state visits were to private high schools.[@NOTE5] 
...
State policymakers have often rationalized funding cuts to public universities on the ground that these organizations can generate their own revenue. While this assumption may be true for some universities, cuts to public funding createi ncentives for universities to prioritize the customers who pay the most, thereyby shifting higher education from a public good to a private good.
